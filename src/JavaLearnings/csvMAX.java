...
public class csvMAX {
	...
	public String coldestFileInDirectory(DirectoryResource dr) {
		...
		for (File file : dr.selectedFiles()) {
			...
			answer = ("The coldest temperature was " + minRecord.get("TemperatureF") + " at " + minRecord.get("DateUTC")
			...
			for (CSVRecord record : parser) {
				if (minRecord == null) {
					...
					if (record.get("Humidity").contains("N/A")==false) {
						System.out.println( record.get("Humidity") + "  " + file.getName());
	...
	public void testColdestHourInFile() {
		...
		System.out
				.println("The coldest temperature was " + output.get("TemperatureF") + " at " + output.get("DateUTC"));
	}
